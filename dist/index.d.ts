...
export { OhhAttendeeData, OhhAttendeeMarkedForPfpPreapprovalData, OhhCoopInviteSentData, OhhFeedbackSubmitterRole, OhhShowingCanceledData, OhhShowingCompletedData, OhhShowingConfirmedData, OhhShowingFeedbackData, OhhShowingFeedbackResponse, OhhShowingLifecycleBaseData, OhhShowingNoShowData, OhhShowingRequestedData, OhhShowingStatus, OhhTourCompletedData, OhhTourCreatedData, OhhTourLifecycleBaseData, ohhAttendeeDataSchema, ohhAttendeeMarkedForPfpPreapprovalDataSchema, ohhCoopInviteSentDataSchema, ohhFeedbackSubmitterRoleSchema, ohhShowingCanceledDataSchema, ohhShowingCompletedDataSchema, ohhShowingConfirmedDataSchema, ohhShowingFeedbackDataSchema, ohhShowingFeedbackResponseSchema, ohhShowingLifecycleBaseDataSchema, ohhShowingNoShowDataSchema, ohhShowingRequestedDataSchema, ohhShowingStatusSchema, ohhTourCompletedDataSchema, ohhTourCreatedDataSchema, ohhTourLifecycleBaseDataSchema } from './schemas/open-house-hub.js';
export { RelloHomePurchasedData, RelloHomeSoldData, relloHomePurchasedDataSchema, relloHomeSoldDataSchema } from './schemas/rello.js';
export { HsLeadMagnetSubmittedData, HsPfpIntakeDeadData, HsTourStopRatedData, hsLeadMagnetSubmittedDataSchema, hsPfpIntakeDeadDataSchema, hsTourStopRatedDataSchema } from './schemas/home-scout.js';
 ...
 */
declare const LEGACY_SIGNALTYPE_EXACT_ALIASES: Readonly<Record<string, ExactCanonicalSignalType>>;
/**
